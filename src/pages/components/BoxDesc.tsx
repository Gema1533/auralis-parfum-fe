...
const BoxDesc = () => {
  return (
    <div className="container text-white mt-10 !p-0">
      ...
      <div className="overflow-x-scroll">
        <div className="flex gap-x-7">
          {[...Array(5)].map((_, index) => (
            <div
              key={index}
              className="w-6/12 md:w-4/12 lg:w-3/12 flex-shrink-0  stelina-blog-item equal-element layout1"
            >
              ...
              <div className="blog-info">
                ...
                <h2 className="blog-title">
                  <a href="#" className="!text-white">
                    We bring you the best by working
                  </a>
                </h2>
