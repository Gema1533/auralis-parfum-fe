...
;(function (e) {
  ...
  ;(e(document).mouseup(function () {
    ...
    e.widget('ui.menu', {
      ...
      _create: function () {
        ;((this.activeOfficeu = this.element),
          (this.mouseHandled = !1),
          this.element
            .uniqueId()
      ...
      _scrollIntoView: function (t) {
        ...
        this._hasScroll() &&
          ((i =
            parseFloat(e.css(this.activeOfficeu[0], 'borderTopWidth')) || 0),
          (s = parseFloat(e.css(this.activeOfficeu[0], 'paddingTop')) || 0),
          (n = t.offset().top - this.activeOfficeu.offset().top - i - s),
          (a = this.activeOfficeu.scrollTop()),
          (o = this.activeOfficeu.height()),
          (r = t.outerHeight()),
          0 > n
            ? this.activeOfficeu.scrollTop(a + n)
            : n + r > o && this.activeOfficeu.scrollTop(a + n - o + r))
      },
      blur: function (e, t) {
      ...
      _move: function (e, t, i) {
        ...
        ;(this.active &&
          ...
          (s && s.length && this.active) ||
            (s = this.activeOfficeu.find(this.options.items)[t]()),
          this.focus(i, s))
      },
      nextPage: function (t) {
        var i, s, n
        ...
        return this.active
          ? (this.isFirstItem() ||
              (this._hasScroll()
                ...
                : this.focus(
                    t,
                    this.activeOfficeu.find(this.options.items).first(),
                  )),
            void 0)
          : (this.next(t), void 0)
      },
    ...
    e.widget('ui.selectmenu', {
      ...
      _refreshOfficeu: function () {
        ...
        t.length &&
          ...
          this._renderOfficeu(this.menu, this.items),
