    ...
    simpleLightboxVideo: function () {
      ...
      return (
        c.click(function () {
          ...
          var c =
              '<iframe src="" width="640" height="360" id="slvj-video-embed" style="border:0;"></iframe>',
          ...
          return (
            ...
            a('#slvj-close-icon').click(function () {
              a('#slvj-window').fadeOut(
                a.simpleLightboxVideo.vars.delayAnimation,
                function () {
                  a(this).remove()
                },
              )
